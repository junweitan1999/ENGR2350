...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$lab1_1.c$36$1$12 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:36: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$lab1_1.c$38$1$30 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:38: Sys_Init();        // System Initialization
	lcall	_Sys_Init
	C$lab1_1.c$39$1$30 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:39: putchar(' ');      // the quote fonts may not copy correctly into SiLabs IDE
	mov	dpl,#0x20
	lcall	_putchar
	C$lab1_1.c$40$1$30 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:40: Port_Init();       // Initialize ports 2 and 3 
	lcall	_Port_Init
	C$lab1_1.c$42$1$30 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:42: while (1)          // infinite loop 
00102$:
	C$lab1_1.c$46$2$31 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:46: Set_outputs();
	lcall	_Set_outputs
	sjmp	00102$
	C$lab1_1.c$48$1$30 ==.
	XG$main$0$0 ==.
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$lab1_1.c$54$1$30 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:54: void Port_Init(void)
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$lab1_1.c$57$1$33 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:57: P3MDOUT |=0xD8; // set Port 3 output pins to push-pull mode (fill in the blank) 11101000
	orl	_P3MDOUT,#0xd8
	C$lab1_1.c$58$1$33 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:58: P3MDOUT &=0xFC; // set Port 3 input pins to open drain mode (fill in the blank) 11111100
	anl	_P3MDOUT,#0xfc
	C$lab1_1.c$59$1$33 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:59: P3 |=~0xFC; // set Port 3 input pins to high impedance state (fill in the blank)
	orl	_P3,#0x03
	C$lab1_1.c$63$1$33 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:63: P2MDOUT &= 0xFE;
	anl	_P2MDOUT,#0xfe
	C$lab1_1.c$64$1$33 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:64: P2 |= 0x01;
	orl	_P2,#0x01
	C$lab1_1.c$67$1$33 ==.
	XG$Port_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$Set_outputs$0$0 ==.
	C$lab1_1.c$78$1$33 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:78: void Set_outputs(void)
;	-----------------------------------------
;	 function Set_outputs
;	-----------------------------------------
_Set_outputs:
	C$lab1_1.c$80$1$35 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:80: if (!SS)        // if Slide Switch activated (On position)
	jnb	_SS,00139$
	ljmp	00114$
00139$:
	C$lab1_1.c$84$2$36 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:84: if (PB1==0 && PB2==0)
	jb	_PB1,00110$
	jb	_PB2,00110$
	C$lab1_1.c$86$3$37 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:86: LED0 = 1;
	setb	_LED0
	C$lab1_1.c$87$3$37 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:87: Buzzer = 1;
	setb	_Buzzer
	C$lab1_1.c$88$3$37 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:88: BILED0 = 0;
	clr	_BILED0
	C$lab1_1.c$89$3$37 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:89: BILED1 = 1;
	setb	_BILED1
	C$lab1_1.c$90$3$37 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:90: printf("biled is red 2 PBs pressed");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
...
00110$:
	C$lab1_1.c$92$2$36 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:92: else if (!PB1 && PB2==1)
	jb	_PB1,00106$
	jnb	_PB2,00106$
	C$lab1_1.c$94$3$38 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:94: LED0 = 1;
	setb	_LED0
	C$lab1_1.c$95$3$38 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:95: Buzzer = 0;
	clr	_Buzzer
	C$lab1_1.c$96$3$38 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:96: BILED0=1;
	setb	_BILED0
	C$lab1_1.c$97$3$38 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:97: BILED1=1;
	setb	_BILED1
	C$lab1_1.c$98$3$38 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:98: printf("buzzer is on");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
...
00106$:
	C$lab1_1.c$100$2$36 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:100: else if (PB1==1 && !PB2)
	jnb	_PB1,00102$
	jb	_PB2,00102$
	C$lab1_1.c$102$3$39 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:102: LED0 = 0;
	clr	_LED0
	C$lab1_1.c$103$3$39 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:103: Buzzer = 1;
	setb	_Buzzer
	C$lab1_1.c$104$3$39 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:104: BILED0=1;
	setb	_BILED0
	C$lab1_1.c$105$3$39 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:105: BILED1=1;
	setb	_BILED1
	C$lab1_1.c$106$3$39 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:106: printf("led is on");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
...
00102$:
	C$lab1_1.c$110$3$40 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:110: BILED0 = 1;   // turn off BILED 
	setb	_BILED0
	C$lab1_1.c$111$3$40 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:111: BILED1 = 1;
	setb	_BILED1
	C$lab1_1.c$112$3$40 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:112: printf("\r biled off\n");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
...
00114$:
	C$lab1_1.c$118$2$41 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:118: LED0 = 1;   // turn off LED0 
	setb	_LED0
	C$lab1_1.c$119$2$41 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:119: BILED1 = 0;
	clr	_BILED1
	C$lab1_1.c$120$2$41 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:120: BILED0 = 1;
	setb	_BILED0
	C$lab1_1.c$121$2$41 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:121: Buzzer = 1;
	setb	_Buzzer
	C$lab1_1.c$123$2$41 ==.
;	C:\Users\Ì´¿¡Î°\Desktop\litec\lab1-1.c:123: printf("\r Slide switch is off   \n");	
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
...
Flab1_1$__str_0$0$0 == .
___str_0:
	.ascii "biled is red 2 PBs pressed"
	.db 0x00
Flab1_1$__str_1$0$0 == .
___str_1:
	.ascii "buzzer is on"
