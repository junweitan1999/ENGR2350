...
S:Lmode3.getchar$c$1$10({1}SC:U),R,0,0,[r7]
S:Lmode3.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$counts$0$0({2}SI:S),E,0,0
S:Lmode3.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:Lmode3.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:Lmode3.generate_random_number$var$1$70({1}SC:U),R,0,0,[r5]
S:Lmode3.generate_random_number$high_bits$1$70({1}SC:U),R,0,0,[r7]
S:Lmode3.generate_random_number$i$1$70({2}SI:S),R,0,0,[]
S:Lmode3.mode3$var$1$74({1}SC:U),E,0,0
S:Lmode3.mode3$input$1$74({1}SC:U),R,0,0,[r7]
S:Lmode3.mode3$PoT$1$74({1}SC:U),R,0,0,[r2]
S:Lmode3.mode3$score$1$74({2}SI:S),R,0,0,[r3,r4]
S:Lmode3.mode3$overflow$1$74({2}SI:S),R,0,0,[r5,r6]
S:Lmode3.mode3$temporarycount$1$74({2}SI:S),R,0,0,[r5,r6]
S:Lmode3.mode3$score_timer$1$74({2}SI:S),E,0,0
S:Lmode3.mode3$submit_timer$1$74({2}SI:S),E,0,0
S:Lmode3.mode3$debounce_count$1$74({2}SI:S),R,0,0,[r5,r6]
S:Lmode3.mode3$mode$1$74({1}SC:U),R,0,0,[r4]
S:Lmode3.mode3$lock_in_counts$3$76({2}SI:S),R,0,0,[]
S:Lmode3.mode3$sloc0$1$0({2}SI:S),E,0,0
...
S:G$click$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$Timer0_ISR$0$0({2}DF,SV:S),C,0,0
S:G$blink$0$0({2}DF,SV:S),C,0,0
S:Fmode3$__str_0$0$0({8}DA8d,SC:S),D,0,0
S:Fmode3$__str_1$0$0({22}DA22d,SC:S),D,0,0
S:Fmode3$__str_2$0$0({7}DA7d,SC:S),D,0,0
S:Fmode3$__str_3$0$0({20}DA20d,SC:S),D,0,0
S:Fmode3$__str_4$0$0({9}DA9d,SC:S),D,0,0
S:Fmode3$__str_5$0$0({8}DA8d,SC:S),D,0,0
S:Fmode3$__str_6$0$0({15}DA15d,SC:S),D,0,0
S:Fmode3$__str_7$0$0({15}DA15d,SC:S),D,0,0
S:Fmode3$__str_8$0$0({43}DA43d,SC:S),D,0,0
S:Fmode3$__str_9$0$0({46}DA46d,SC:S),D,0,0
S:Fmode3$__str_10$0$0({3}DA3d,SC:S),D,0,0
